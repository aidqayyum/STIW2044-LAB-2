  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      body: Column(children: <Widget>[
        ...
        initialUrl: 'http://itschizo.com/aidil_qayyum/etrash/php/payment.php?email='+widget.user.email+'&mobile='+widget.user.phone+'&name='+widget.user.name+'&amount='+widget.val+'&orderid='+widget.orderid,
