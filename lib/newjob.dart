...
File _image;
String pathAsset = 'assets/images/slivertrash.png';
String urlUpload = "http://itschizo.com/aidil_qayyum/etrash/php/upload_item.php";
                           ...
                           new IconButton(iconSize: 40, icon: new Icon(Icons.fastfood), onPressed: _changeFood),
                                           ...
                                           void _loadmap() async {
                                             LocationResult result = await Navigator.of(context).push(MaterialPageRoute(
                                                 builder: (context) =>
                                                     PlacePicker("AIzaSyCAUK7Ag2y3T5iMux5-YM8S_Ao_Axzk2VA")));
